...
function Index() {
  ...
  return (
    <PhoneFrame>
      <>
        <StatusBar />
        <div className="relative flex-1 flex flex-col justify-between px-6 pt-2 pb-6 overflow-hidden select-none">
          {/* Ambient background */}
          <div
            aria-hidden
          ...
          {/* Center Content */}
          <div className="relative flex flex-col items-center text-center my-auto py-2">
            <h1
              style={{
                fontSize: 32,
                lineHeight: 1.1,
          ...
          {/* Footer */}
          <div
            className="relative text-center pb-2 shrink-0"
